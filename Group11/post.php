...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table align="left" border="0" cellpadding="0" cellspacing="0" width="700">
        <tr>
          ...
          <td><a href="index1.php"><img name="board_r1_c5" src="images/read.jpg" width="110" height="36" border="0" alt="瀏覽留言"></a></td>
  ...
  <tr>
    <td background="images/board_r3_c1.jpg"><div id="mainRegion">
        <form action="post_finish.php" method="post" name="formPost" id="formPost" onSubmit="return checkForm();">
